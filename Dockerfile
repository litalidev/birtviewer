...
RUN wget "https://dlm.mariadb.com/3752081/Connectors/java/connector-java-3.3.3/mariadb-java-client-3.3.3.jar" -P /opt/tomcat/webapps/birt/WEB-INF/lib/
